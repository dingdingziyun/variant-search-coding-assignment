...
def table_link(input_value):
    ...
    if input_value != None and input_value in available_indicators:
        ...
        return html.Table(
                        ...
                        rows,className='display', style={'border':'1.5px', 'font-size':'1.2rem', 'width': '30%'}
                        )
